...
from custom_widgets import RoundedLabel
...
class Ui_Form(object):
    def __init__(self):
        ...
        self.function_map = {
            ...
            "discussion": lambda: discussion_based_ranking(self.G, 1),
            "burden": lambda: burden_based_ranking(self.G, 10),
            "tuple": lambda: tuple_based_ranking(self.G),
            "Matt & Toni": lambda: mt_ranking_func(self.G),
        }
    ...
    def handle_alpha_burden(self, alpha_value):
        if alpha_value == 0:
            return ""
        return alpha_burden_based_ranking(self.G, alpha_value)
